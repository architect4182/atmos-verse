      ...
      <div className="mx-auto max-w-[1800px] px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {SERVICES.map((service) => (
            ...
            >
              <div className={cn("absolute inset-0 bg-gradient-to-t opacity-30 group-hover:opacity-100 transition-opacity duration-500", service.bgClass)} />
              ...
              >
                <img 
                  ...
                  className={cn(
                    ...
                    // Crunchyroll and Max need brightness adjustments
                    (service.name === "Crunchyroll" || service.name === "Max") 
                      ? "brightness-0 invert opacity-80 group-hover:opacity-100 group-hover:brightness-100 group-hover:invert-0" 
